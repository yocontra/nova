require.register('zepto', function (module, exports, require) {
  //     Zepto.js
  ...
  var Zepto = (function () {
    ...
    function $(selector, context) {
      ...
      if (context !== undefined) return $(context).find(selector);
        ...
        else if (fragmentRE.test(selector)) dom = fragment(selector, RegExp.$1), selector = null;
    ...
    $.fn = {
      ...
      attr: function (name, value) {
        return (typeof name == 'string' && value === undefined) ? (this.length > 0 && this[0].nodeName == 'INPUT' && this[0].type == 'text' && name == 'value') ? (this.val()) : (this.length > 0 ? this[0].getAttribute(name) || (name in this[0] ? this[0][name] : undefined) : undefined) : this.each(function (idx) {
      ...
      val: function (value) {
        return (value === undefined) ? (this.length > 0 ? this[0].value : null) : this.each(function () {
          this.value = value;
        });
      },
      offset: function () {
      ...
      css: function (property, value) {
        if (value === undefined && typeof property == 'string') return this[0].style[camelize(property)] || getComputedStyle(this[0], '').getPropertyValue(property);
        var css = '';
      ...
      toggleClass: function (name, when) {
        return this.each(function (idx) {
          var cls = this.className,
            newName = funcArg(this, name, idx, cls);
          ((when !== undefined && !when) || $(this).hasClass(newName)) ? $(this).removeClass(newName) : $(this).addClass(newName)
        });
      }
    };
    ...
    function insert(operator, target, node) {
      ...
      parent.insertBefore(node, !operator ? parent.firstChild : // prepend
  ...
  //     Zepto.js may be freely distributed under the MIT license.
  (function ($, undefined) {
    var supportedTransforms = ['scale', 'scaleX', 'scaleY', 'translate', 'translateX', 'translateY', 'translate3d', 'skew', 'skewX', 'skewY', 'rotate', 'rotateX', 'rotateY', 'rotateZ', 'rotate3d', 'matrix'];
    ...
    $.fn.anim = function (properties, duration, ease, callback) {
      ...
      if (supportedTransforms.indexOf(key) >= 0) transforms.push(key + '(' + properties[key] + ')');
      ...
      else setTimeout(wrappedCallback, 0);
    ...
    $.param = function (obj, v) {
      var result = [],
        add = function (key, value) {
          result.push(encodeURIComponent(v ? v + '[' + key + ']' : key) + '=' + encodeURIComponent(value));
        },
        isObjArray = $.isArray(obj);

      for (key in obj)
      if (isObject(obj[key])) result.push($.param(obj[key], (v ? v + '[' + key + ']' : key)));
      else add(isObjArray ? '' : key, obj[key]);
