require.register('es5-shim', function (module, exports, require) {
  ...
  (function (definition) {
    ...
    if (!Function.prototype.bind) {
      Function.prototype.bind = function bind(that) { // .length is 1
        ...
        if (typeof target.apply != "function" || typeof target.call != "function") return new TypeError();
    ...
    if (!prototypeOfArray.reduce) {
      prototypeOfArray.reduce = function reduce(fun /*, initial*/ ) {
        ...
        if (toString.call(fun) != "[object Function]") throw new TypeError();
        ...
        for (; i < length; i++) {
          if (i in self) result = fun.call(null, result, self[i], i, self);
        }
    ...
    if (!prototypeOfArray.reduceRight) {
      prototypeOfArray.reduceRight = function reduceRight(fun /*, initial*/ ) {
        ...
        do {
          if (i in this) result = fun.call(null, result, self[i], i, self);
        } while (i--);
    ...
    if (!defineProperty) {
      ...
      Object.defineProperty = function defineProperty(object, property, descriptor) {
        if (typeof object != "object" && typeof object != "function") throw new TypeError(ERR_NON_OBJECT_TARGET + object);
        if (typeof descriptor != "object" || descriptor === null) throw new TypeError(ERR_NON_OBJECT_DESCRIPTOR + descriptor);
        // make a valiant attempt to use the real defineProperty
        // for I8's DOM elements.
        if (oldDefineProperty && object.nodeType) return oldDefineProperty(object, property, descriptor);
...
/*
    ...
    if (!Object.keys) {
      ...
      Object.keys = function keys(object) {
        ...
        if (
        typeof object != "object" && typeof object != "function" || object === null) throw new TypeError("Object.keys called on a non-object");
    ...
    if (!Date.prototype.toJSON) {
      Date.prototype.toJSON = function toJSON(key) {
        ...
        // XXX this gets pretty close, for all intents and purposes, letting
        // some duck-types slide
        if (typeof this.toISOString.call != "function") throw new TypeError();
    ...
    if (isNaN(Date.parse("2011-06-15T21:40:05+06:00"))) {
      ...
      Date = (function (NativeDate) {
        ...
        var isoDateExpression = new RegExp("^" + "(\\d{4})" + // four-digit year capture
