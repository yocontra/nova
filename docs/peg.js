  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_unit() {
        ...
        if (result4 !== null) {
          ...
          if (result3 !== null) {
            ...
            var result2 = parse_multi_line_comment();
            if (result2 !== null) {
              var result0 = result2;
            } else {
              var result1 = parse_any_char();
              if (result1 !== null) {
                var result0 = result1;
              } else {
                var result0 = null;;
      ...
      function parse_func() {
        ...
        var savedPos2 = pos;
        var savedPos3 = pos;
        var result10 = parse_multi_line_comment();
        if (result10 !== null) {
          var result15 = parse_spaces();
          var result11 = result15 !== null ? result15 : '';
          if (result11 !== null) {
            if (input.substr(pos, 8) === "function") {
              var result12 = "function";
              pos += 8;
            } else {
              var result12 = null;
        ...
        var result9 = result8 !== null
          ? (function(m, id) {functions[id] = m;})(result8[0], result8[4])
          : null;
        if (result9 !== null) {
          var result7 = result9;
        } else {
        ...
        if (result7 !== null) {
          ...
          var result3 = result2 !== null
            ? (function(id) {functions[id] = null;})(result2[2])
            : null;
          if (result3 !== null) {
            var result1 = result3;
          } else {
      ...
      function parse_multi_line_comment() {
        var cacheKey = 'multi_line_comment@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (result3 !== null) {
          ...
          var savedPos2 = pos;
          var savedPos3 = pos;
          var result8 = (function() {return buffer.match(/\*\//)})() ? null : '';
          if (result8 !== null) {
            if (input.length > pos) {
      ...
      function parse_identifier() {
        ...
        var result2 = result1 !== null
          ? (function(a, b) {return a + b.join("");})(result1[0], result1[1])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
